...
<img style="border: 1.5px solid black; border-radius: 5px; " class ="pics" src="/blog/Pics_for_I,Robot/I-Robot Cover.jpg" alt = "I, Robot cover" width="500px" height= auto >
</div>
...
<div style="text-align: center;">
<img style="border: 1.5px solid black; border-radius: 5px; " class ="pics" src="/blog/Pics_for_I,Robot/I,Robot-CarScene.jpg" alt = "I, Robot Drowning car scene" width="500px" height= auto >
</div>
...
<div style="text-align: center; ">
<img style="border: 1px solid black; border-radius: 5px; " class ="pics" src="/blog/Pics_for_I,Robot/I,Robot-takingout-trash.png" alt = "I, Robot taking out trash" width="500px" height= auto >
<img style="border: 1px solid black; border-radius: 5px; " class ="pics" src="/blog/Pics_for_I,Robot/I,Robot-walking-dogs.png" alt = "I, Robot walkign dogs" width="500px" height= auto >
</div>
...
<div style="text-align: center;">
<img style="border: 1px solid black; border-radius: 5px; " class ="pics" src="/blog/Pics_for_I,Robot/Sonnys-dream.jph" alt = "Sonny's Dream" width="500px" height= auto >
</div>

The last scene which I liked that depicted the aspect of AI was the scene in which Sonny was tied up to a chair, and said he was dreaming when he woke up. This scene depicts the aspect of emotion in AI in which in the future by some concept they’ll be able to process emotion similar to that of human beings. This portrayal seems most likely unrealistic because I believe that to have emotions, you have to be a living person, a person with a soul. Ex: humans and animals. Although when talking to an AI they seem very emotional, remember it’s in their programming to sound so. But in the case of the movie “I, Robot” seemingly such scenarios aren't far off with how far technology has advanced.



<h1> Overall opinion</h1>

Overall, this movie has opened up questions for me about the future possibilities of AI. As depicted in the movie, one concern I have–though I believe isn’t happening anytime soon since we aren’t at that level yet–is the main AI taking over the other ones and using them to take control of the world. Or a virus causing something similar to happen. In addition, another concern I have with the advancements of AI are the new rules and regulations that will have to be put in place. For example, Grok, an artificial intelligence, has been blocked by different countries due to safety and legal concerns, including the generation of sexualized or harmful content that violated guidelines and local laws, and targeted women and children. Among that, there are multiple cases of AI being used for misharms; such as phishing attacks, spamming and even in some severe cases hacking. Hence the concern of mine in which new laws and regulations must be put in place to prevent such cases.